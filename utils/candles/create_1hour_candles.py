...
if redis_db.get('is_1hour_candle_creator_active') == b'True':
    exit()
redis_db.set('is_1hour_candle_creator_active', 'True')
redis_db.set('1hour_candle_creator_time', time.time())


source_interval = '15min'
target_interval = '1hour'
